...
(function (containmoney) {
     ...
     *
     */
    var ContainmoneyUI = (function () {
        function ContainmoneyUI() {
            this.redPackets = [];
            this.arr = [];
            //    		this.init();
        }
        var d = __define,c=ContainmoneyUI,p=c.prototype;
        ContainmoneyUI.getInstance = function () {
            if (!this._instance) {
        ...
        p.saveActivePackets = function (str) {
            this.redPackets.push(str);
            this.addRedPackets();
        };
        p.addRedPackets = function () {
        ...
        return ContainmoneyUI;
    }());
    containmoney.ContainmoneyUI = ContainmoneyUI;
    egret.registerClass(ContainmoneyUI,'containmoney.ContainmoneyUI');
